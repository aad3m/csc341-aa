...
public class Hasher {
    ...
    */
     ...
     */
    public String asciify(int[] decimalArray) {
    ...
    public String hash(String password) {
        ...
        // for example, key="a^z" key2hex=615e7a
        ...
        // for example key2hex="615e7a" key2dec={6,1,5,14,7,10}
        int[] key2dec = decimate(key2hex);

        if (debug) printArray(key2dec,"key DECI = ");

		// Add characters to the password to fix the length
