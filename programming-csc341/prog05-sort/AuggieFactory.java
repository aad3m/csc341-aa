...
public class AuggieFactory {
	...
	*/
    ...
    private static String[] lasts = { 
    	"Larson", "Steinmetz", "Atukorala","Pattanayak", "Haines", "Doree", "Belik", "Zobitz", "Sorensen", "Voyles", "Flint", "Chen", "Chafee",  "Crowe", "Averbeck", "Klassin", "Brandl", "Mohamud", "Ahmed", "Xiong", "Memeti", "Lee", "Ng", "Nguyen", "Abdi", "Czech", "Vang", "OKeefe", "Atto", "Leal", "Hersi", "Mohammad", "Abukar", "Mckinnon", "Osman", "Yang", "Yusuf", "Edow", "Kempenich", "Adan", "Ali", "Hagen", "Torres", "Warns", "Beeby", "Gottimukala", "Alvarado","Boyer", "Sati", "Wadhawan", "Vo", "Ramales", "Owusu","Carrillo","Hopper","Lovelace","Ellis", "Bryan", "Fatty", "Abdullahi", "Abukar", "Adem", "Ahmed", "Bashige", "Belayneh", "Bigwood", "Clark", "Davidson", "Maxmud", "Mccarl", "Mensah", "Mohamed", "Moktar", "Ochoa Martinez", "Saw Tamalar", "Tran", "Xiong", "Yusuf"
    };
}